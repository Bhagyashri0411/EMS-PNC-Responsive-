...
function getPotentialAreaData() {
    ...
    $.ajax({
        ...
        url: "http://192.168.1.123:8080/potentialgraph",
...
function getSpecificOptConsumptionData() {
    ...
    $.ajax({
        ...
        url: "http://192.168.1.123:8080/overallenergycost",
    }).done(function (data) {
...
function optimizedtable() {
    $.ajax({
        ...
        method: 'GET',
        url: "http://192.168.1.123:8080/majorcontributor",
    }).done(function (data) {
        var table_data = '';
        var max1 = 500;
...
function optimizedfuel() {
    $.ajax({
        ...
        method: 'GET',
        url: "http://192.168.1.123:8080/fuelsystemoverview",
    }).done(function (data) {
        var table_data = '';
        var max1 = 500;
        $.each(data, function (key, value) {
...
function optimizedElectrical() {
    $.ajax({
        ...
        method: 'GET',
        url: "http://192.168.1.123:8080/electricalpowersystem",
    }).done(function (data) {
        var table_data1 = '';
        var max1 = 700;
        $.each(data, function (key, value) {
...
function steamPotential() {
    $.ajax({
        ...
        method: 'GET',
        url: 'http://192.168.1.123:8080/potentialopportunity',
    }).done(function (data) {
