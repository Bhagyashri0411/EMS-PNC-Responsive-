...
function getPotentialAreaData() {
    ...
    $.ajax({
        ...
        url: "http://localhost:8090/EMSPro/potentialgraph",
...
function getSpecificOptConsumptionData() {
    ...
    $.ajax({
        ...
        url: "http://localhost:8090/EMSPro/overallenergycost",
    }).done(function (data) {
...
function optimizedtable() {
    $.ajax({
        ...
        method: 'GET',
        url: "http://localhost:8090/EMSPro/majorcontributor",
    }).done(function (data) {
        var table_data = '';
        var max1 = 500;
...
function optimizedfuel() {
    $.ajax({
        ...
        method: 'GET',
        url: "http://localhost:8090/EMSPro/fuelsystemoverview",
    }).done(function (data) {
        var table_data = '';
        var max1 = 500;
        $.each(data, function (key, value) {
...
function optimizedElectrical() {
    $.ajax({
        ...
        method: 'GET',
        url: "http://localhost:8090/EMSPro/electricalpowersystem",
    }).done(function (data) {
        var table_data1 = '';
        var max1 = 700;
        $.each(data, function (key, value) {
...
function steamPotential() {
    $.ajax({
        ...
        method: 'GET',
        url: 'http://localhost:8090/EMSPro/potentialopportunity',
    }).done(function (data) {
