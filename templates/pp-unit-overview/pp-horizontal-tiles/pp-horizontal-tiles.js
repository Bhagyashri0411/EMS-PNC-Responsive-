...
function pploadGaugeChart() {
    $.ajax({
        type: "GET",
        url: "http://localhost:8080/pp/specificenergyConsumption",
    }).done(function (data) {
...
function cardpp1() {
    $.ajax({
        url: 'http://localhost:8080/pp/secsteamcart',
        method: "GET"
    }).done(function (data) {
...
function cardpp2() {
    $.ajax({
        url: 'http://localhost:8080/pp/secelectricitycart',
        method: "GET"
    }).done(function (data) {
...
function cardpp3() {
    $.ajax({
        url: 'http://localhost:8080/pp/totalelectricityConsumption',
        method: "GET"
    }).done(function (data) {
...
function cardpp4() {
    $.ajax({
        url: 'http://localhost:8080/pp/totalelectricityConsumptionSHPEquivalent',
        method: "GET"
    }).done(function (data) {
...
function getDoughnutpp() {
    ...
    $.ajax({
        ...
        url: "http://localhost:8080/pp/PPDoughnu",
    }).done(function (data) {
        showDoughnutpp(data);
    })
    .fail(function(){
