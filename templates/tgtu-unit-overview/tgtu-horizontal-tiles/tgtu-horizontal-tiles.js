...
function tgtuloadGaugeChart() {
    $.ajax({
        type: "GET",
        url: "http://192.168.1.123:8080/api/npruunitOverview/specificeneryconsumption",
...
function srusteamconsumptionbreakup() {
    $.ajax({
      url: "http://192.168.1.123:8080/api/srutgtuOverview/SteamConsumptionBreakup",
      method: "GET"
  ...
  function getcard() {
    $.ajax({
         url:"http://192.168.1.123:8080/api/srutgtuOverview/getCardDetails",
        method: "GET"
    }).done(function(data) {
        console.log(data)
