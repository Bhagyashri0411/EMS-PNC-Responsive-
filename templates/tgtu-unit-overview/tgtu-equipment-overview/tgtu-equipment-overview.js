...
function getSpecificTGTUOverviewData() {
    ...
    $.ajax({
            ...
            url: "http://localhost:8080/api/srutgtuOverview/efficiencyTrends",
        }).done(function(data) {
            console.log(data)
...
function getEquOverTGTUData() {
    $.ajax({
            method: "GET",
            url: "http://localhost:8080/api/srutgtuOverview/equipmentEfficiencies",
        }).done(function(data) {
...
//table
$.ajax({
    url: "http://localhost:8080/api/srutgtuOverview//kpiOverview",
    method: "GET"
}).done(function(data) {
    var table_data = '';
