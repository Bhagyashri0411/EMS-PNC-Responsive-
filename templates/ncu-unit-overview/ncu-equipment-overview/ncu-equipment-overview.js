...
function getEquOverFCCUData() {
    $.ajax({
        method: "GET",
        url: "http://localhost:8090/EMSPro/EquipmentOverview/DHDSchart",
...
function posttableequipment() {
    ...
    $.ajax({
        ...
        url: "http://localhost:8090/EMSPro/EquipmentOverview/DHDStable",
    }).done(function (data) {
...
function getSpecificEquipmentOverviewDataNCU() {
    ...
    $.ajax({
        ...
        url: "http://localhost:8090/EMSPro/EquipmentOverview/DHDSgraph",
    }).done(function (data) {
        console.log(data)
