$(document).ready(function () {
    ...
    d.setMinutes(30);
    d.setSeconds(0);
    $('#fromHomencu').val(d.toJSON().slice(0, 20));
    const tod = new Date(sessionStorage.getItem("lastUpdateddate"));
    tod.setHours(29);
    tod.setMinutes(29);
    tod.setSeconds(0);
    $('#toHomencu').val(tod.toJSON().slice(0, 20));
...
function ncusteamoverview() {
    ...
    $.ajax({
        ...
        url: "http://192.168.1.124:8080/ncu/steamgenerationgraph",
...
function ncusteamta() {
    $.ajax({
        url: "http://192.168.1.124:8080/ncu/Steambalance",
        method: "GET"
    }).done(function (data) {
        var table_data = '';
