...
function getEquOverFCCUData() {
    $.ajax({
        method: "GET",
        url: "http://192.168.1.123:8080/EquipmentOverview/DHDSchart",
...
function posttableequipment() {
    ...
    $.ajax({
        ...
        url: "http://192.168.1.123:8080/EquipmentOverview/DHDStable",
    }).done(function (data) {
...
function getSpecificEquipmentOverviewDataNCU() {
    ...
    $.ajax({
        ...
        url: "http://192.168.1.123:8080/EquipmentOverview/DHDSgraph",
    }).done(function (data) {
        console.log(data)
