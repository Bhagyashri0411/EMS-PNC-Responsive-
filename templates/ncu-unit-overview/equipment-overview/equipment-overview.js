...
function getEquOverFCCUData() {
    $.ajax({
        method: "GET",
        url: "http://localhost:8090/EquipmentOverview/DHDSchart",
...
function posttableequipment() {
    ...
    $.ajax({
        ...
        url: "http://localhost:8090/EquipmentOverview/DHDStable",
    }).done(function (data) {
...
function getSpecificEquipmentOverviewDataNCU() {
    ...
    $.ajax({
        ...
        url: "http://localhost:8090/EquipmentOverview/DHDSgraph",
    }).done(function (data) {
        console.log(data)
