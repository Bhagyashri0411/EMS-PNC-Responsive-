...
function getSpecificAirConsumptionData() {
    ...
    $.ajax({
        ...
        method: "POST",
        data: postdata,
        url: " http://localhost:8080/EMSPro/auth/Air/PlantAirGeneration",
    }).done(function (data) {
        console.log(data)
...
function plantair(kpiname) {
    ...
    $.ajax({
        ...
        data: postdata,
        // url: "http://localhost:8080/EMSPro/auth/Air/airconsumerTable",
        url: "http://localhost:8080/Air/plantairtable",
        method: "POST"
...
function instrumentair(kpiname) {
    ...
    $.ajax({
        ...
        url: "http://localhost:8080/Air/airconsumerTable",
        // url: "http://localhost:8080/EMSPro/auth/Air/airconsumerTable",
        method: "POST"
...
function Aircard1() {
    $.ajax({
        ...
        url: "http://localhost:8080/Air/PlantAirTotalGeneration", 
        method: "GET"
    }).done(function (data) {
        console.log(data)
...
function Aircard2() {
    $.ajax({
        ...
        url: "http://localhost:8080/Air/PlantAirTotalConsumption",
        method: "GET",
    }).done(function (data) {
        console.log(data)
        if (data.currentvalue > 0) {
...
function Aircard3() {
    $.ajax({
        ...
        url: "http://localhost:8080/Air/InstrumentAirTotalGeneration",
        method: "GET",
    }).done(function (data) {
        console.log(data)
        if (data.currentvalue > 0) {
...
function Aircard4() {
    $.ajax({
        ...
        url: "http://localhost:8080/Air/InstrumentAirTotalConsumption",
        method: "GET"
    }).done(function (data) {
        console.log(data)
        if (data.currentvalue > 0) {
