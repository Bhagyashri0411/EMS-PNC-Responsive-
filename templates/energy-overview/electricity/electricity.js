...
function getSpecificElectricityConsumptionData() {
    ...
    $.ajax({
        ...
        url: "http://localhost:8080/auth/electricity/SpecificElectricity",
    }).done(function (data) {
        console.log(data)
...
function electricityDoughnutProgress2() {
    $.ajax({
        ...
        method: "GET",
        url: "http://localhost:8080/auth/electricity/ElectricityCapacity",
    }).done(function (data) {
...
function getcardElectricity1() {
    $.ajax({
        url: 'http://localhost:8080/auth/electricity/secelectricity',
        method: "GET"
    }).done(function (data) {
...
function getcardElectricity2() {
    $.ajax({
        url: "http://localhost:8080/auth/electricity/ElectricityTotalGeneration",
        method: "GET"
    }).done(function (data) {
...
function getcardElectricity3() {
    $.ajax({
        url: 'http://localhost:8080/auth/electricity/ElectricityTotalConsumption',
        method: "GET"
    }).done(function (data) {
...
function getcardElectricity4() {
    $.ajax({
    url: 'http://localhost:8080/auth/electricity/ElectricityGenerationCost',
        method: "GET"
    }).done(function (data) {
...
//     $.ajax({
//         method: "GET",
//         url: "http://localhost:8080/auth/electricity/TotalElectricity",
