...
function getSpecificSteamline1ConsumptionData() {
    ...
    $.ajax({
        ...
        url: "http://192.168.1.123:8080/steam/steamGraph",
    }).done(function (data) {
        console.log(data)
...
function getSpecificSteamConsumptionData() {
    ...
    $.ajax({
        ...
        url: "http://192.168.1.123:8080/steam/specificsteamconsumption",
    }).done(function (data) {
        console.log(data)
...
function steamDoughnut() {
    $.ajax({
        method: "GET",
        url: "http://192.168.1.123:8080/steam/steamBreakup",
    }).done(function (data) {
...
function steamtable() {
    $.ajax({
        url: "http://192.168.1.123:8080/steam/secSteam",
        method: "GET"
    }).done(function (data) {
        console.log(data)
        var table_data = '';
...
function steamtable2() {
    $.ajax({
        method: 'GET',
        url: 'http://192.168.1.123:8080/steam/steamTable'
    }).done(function (data) {
        var table_data = '';
        $.each(data, function (key, value) {
            table_data += '<tr>';
...
function steamDoughnutProgress2() {
    $.ajax({
        ...
        method: "GET",
        url: "http://192.168.1.123:8080/steam/steamCapacityUtilization",
    }).done(function (data) {
