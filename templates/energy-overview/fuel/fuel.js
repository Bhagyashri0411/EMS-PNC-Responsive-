...
function getSpecificFuelPNCData() {
    ...
    $.ajax({
        ...
        url: "http://192.168.1.123:8080/eco/fuelgraph",
    }).done(function (data) {
        console.log(data)
...
function getFuelDoughnutData() {
    ...
    $.ajax({
        ...
        url: "http://192.168.1.123:8080/eco/totalfuelconsumed",
    }).done(function (data) {
...
function loadCardfuel1() {
    $.ajax({
        method: "GET",
        url: "http://192.168.1.123:8080/eco/secfuelMT",
...
function loadCardfuel2() {
    $.ajax({
        method: "GET",
        url: "http://192.168.1.123:8080/eco/secfuelGcal",
