...
function getSpecificFuelPNCData() {
    ...
    $.ajax({
        ...
        url: "http://192.168.1.109:8090/auth/Fuel/fuelgraph",
    }).done(function (data) {
        console.log(data)
...
function getFuelDoughnutData() {
    ...
    $.ajax({
        ...
        url: "http://192.168.1.109:8090/auth/Fuel/totalfuelconsumed",
    }).done(function (data) {
...
function loadCardfuel1() {
    $.ajax({
        method: "GET",
        url: "http://192.168.1.109:8090/auth/Fuel/secfuelToeMT",
...
function loadCardfuel2() {
    $.ajax({
        method: "GET",
        url: "http://192.168.1.109:8090/eco/secfuelGcal",
