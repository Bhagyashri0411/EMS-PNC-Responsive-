...
function genratortable() {
    $.ajax({
        url: "http://localhost:8090/EMSPro/auth/hydogen/hydrogengeneratorTable",
        method: "GET"
...
function consumertable() {
    $.ajax({
        url: "http://localhost:8090/EMSPro/auth/hydogen/hydrogenconsumerTable",
        method: "GET"
...
function exporttable() {
    $.ajax({
        url: "http://localhost:8090/EMSPro/auth/hydogen/newtable",
        method: "GET"
...
function hydrogencard1() {
    $.ajax({
        method: "GET",
        url: "http://localhost:8090/EMSPro/auth/hydogen/totalhydogengen",
...
function hydrogencard2() {
    $.ajax({
        method: "GET",
        url: "http://localhost:8090/EMSPro/auth/hydogen/totalhydrogenconsmptn",
...
function hydrogencard3() {
    $.ajax({
        method: "GET",
        url: "http://localhost:8090/EMSPro/auth/hydogen/hydroloss",
...
function hydrogencard4() {
    $.ajax({
        method: "GET",
        url: "http://localhost:8090/EMSPro/auth/hydogen/imbalance",
