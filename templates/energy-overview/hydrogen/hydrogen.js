...
function getSpecificHydrogenConsumptionData() {
    ...
    $.ajax({
        ...
        url: "http://localhost:8080/auth/hydogen/hydrogengraph",
    }).done(function (data) {
        console.log(data)
...
function genratortable() {
    $.ajax({
        url: "http://localhost:8080/auth/hydogen/hydrogengeneratorTable",
        method: "GET"
...
function consumertable() {
    $.ajax({
        url: "http://localhost:8080/auth/hydogen/hydrogenconsumerTable",
        method: "GET"
...
function exporttable() {
    $.ajax({
        url: "http://localhost:8080/auth/hydogen/newtable",
        method: "GET"
...
function hydrogencard1() {
    $.ajax({
        method: "GET",
        url: "http://localhost:8080/auth/hydogen/totalhydogengen",
...
function hydrogencard2() {
    $.ajax({
        method: "GET",
        url: "http://localhost:8080/auth/hydogen/totalhydrogenconsmptn",
...
function hydrogencard3() {
    $.ajax({
        method: "GET",
        url: "http://localhost:8080/auth/hydogen/hydroloss",
...
function hydrogencard4() {
    $.ajax({
        method: "GET",
        url: "http://localhost:8080/auth/hydogen/imbalance",
