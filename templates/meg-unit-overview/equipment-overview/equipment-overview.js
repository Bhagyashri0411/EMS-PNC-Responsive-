...
function getEquOverMEGData() {
    $.ajax({
        ...
        method: "GET",
        url: "http://localhost:8080/EquipmentOverview/OHCUchart",
...
function equipmentOverviewKpiTableMeg() {
    ...
    $.ajax({
        ...
        url: "http://localhost:8080/EquipmentOverview/OHCUtable",
    }).done(function (data) {
...
function getSpecificEquipmentOverviewDataMEG() {
    ...
    $.ajax({
        ...
        url: "http://localhost:8080/EquipmentOverview/OHCUgraph",
    }).done(function (data) {
        console.log(data)
