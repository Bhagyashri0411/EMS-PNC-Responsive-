...
function getEquOverMEGData() {
    $.ajax({
        ...
        method: "GET",
        url: "http://192.168.1.123:8080/EquipmentOverview/OHCUchart",
...
function equipmentOverviewKpiTableMeg() {
    ...
    $.ajax({
        ...
        url: "http://192.168.1.123:8080/EquipmentOverview/OHCUtable",
    }).done(function (data) {
...
function getSpecificEquipmentOverviewDataMEG() {
    ...
    $.ajax({
        ...
        url: "http://192.168.1.123:8080/EquipmentOverview/OHCUgraph",
    }).done(function (data) {
        console.log(data)
