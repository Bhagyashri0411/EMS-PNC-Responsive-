...
function saveTable() {
  ...
  if (manual_tag_name == "" || reference_value == "" || uom == "" || description == "") {
    ...
    $.ajax({
      ...
      url: "http://localhost:8090/EmsPNC/auth/ManualEntry/Insert",
      data: rowdata1,
...
$('#updateRowBtn').click(function () {8
  ...
  $.ajax({
    ...
    url: "http://localhost:8090/EmsPNC/auth/ManualEntry/Update",
...
function userdeletedata() {
  ...
  if ($("input:checkbox:checked").val() == "Edit Row") {
    ...
    $.ajax({
      ...
      url: "http://localhost:8090/EmsPNC/auth/ManualEntry/Delete",
      success: function (msg) {
