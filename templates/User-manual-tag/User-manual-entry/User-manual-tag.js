...
function getCalculatedTag() {
  $.ajax({
      ...
      method: "GET",
      url: "http://localhost:8090/EmsPNC/Constantlist",
...
//         'Content-Type':false
//         },
//         url: "http://localhost:8090/EmsPNC/upload-csv-file",
//         data:myArr,
//         success: function (msg) {
//              var msg1 = msg;
//              console.log(msg1);
...
xhr.open('POST', 'http://localhost:8090/EmsPNC/upload-csv-file', true);
xhr.onload = function () {
  if (xhr.status === 200) {
