$(document).ready(function () {
    ...
    $('#updateRowBtn').click(function () {
        ...
        $.ajax({
            ...
            url: "http://localhost:8090/EMSPro/update",
...
function ServiceCall() {
    $.ajax({
        ...
        url: "http://localhost:8090/EMSPro/auth/formula/GetFormulaData",
        method: "GET"
    }).done(function (data) {
        console.log(data)
        var tabledata = data;
...
$("#datatablesCalculatedTag").on('click', '.deleteValues', function () {
    ...
    $.ajax({
        ...
        url: "http://localhost:8090/EMSPro/delete",
...
function addNewData() {
    ...
    $.ajax({
        ...
        url: "http://localhost:8090/EMSPro/insert",
...
xhr.open('POST', 'http://localhost:8090/EMSPro/upload-csv-fileformula', true);
