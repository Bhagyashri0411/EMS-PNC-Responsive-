$(document).ready(function () {
    ...
    $('#updateRowBtn').click(function () {
        ...
        $.ajax({
            ...
            url: "http://192.168.1.123:8080/update",
...
function getCalculatedTag() {
    $.ajax({
        ...
        method: "GET",
        url: "http://192.168.1.123:8080/alldata",
...
function ServiceCall() {
    $.ajax({
        ...
        url: "http://192.168.1.123:8080/auth/formula/GetFormulaData",
        method: "GET"
    }).done(function (data) {
        console.log(data)
        var tabledata = data;
...
$("#datatablesCalculatedTag").on('click', '.deleteValues', function () {
    ...
    $.ajax({
        ...
        url: "http://192.168.1.123:8080/delete",
...
function addNewData() {
    ...
    $.ajax({
        ...
        url: "http://192.168.1.123:8080/insert",
...
xhr.open('POST', 'http://192.168.1.123:8080/upload-csv-fileformula', true);
