...
function getCardValue1() {
    ...
    $.ajax({
        ...
        method: "GET",
        url: "http://localhost:8090/EMSPro/auth/tpsoverview/totalPowerGenerated",
...
function getCardValue2() {
    ...
    $.ajax({
        ...
        method: "GET",
        url: "http://localhost:8090/EMSPro/auth/tpsoverview/SpecificFuelConsumtion",
...
function getCardValue3() {
    ...
    $.ajax({
        ...
        method: "GET",
        url: "http://localhost:8090/EMSPro/auth/tpsoverview/specificWater",
...
function getCardValue4() {
    ...
    $.ajax({
        ...
        method: "GET",
        url: "http://localhost:8090/EMSPro/auth/tpsoverview/specificSteam",
...
function getCardValue5() {
    ...
    $.ajax({
        ...
        method: "GET",
        url: "http://localhost:8090/EMSPro/auth/tpsoverview/optimumPowerGeneration",
...
function getCardValue6() {
    ...
    $.ajax({
        ...
        method: "GET",
        url: "http://localhost:8090/EMSPro/auth/tpsoverview/CPPPowerGenerationCost",
...
function getCardValue7() {
    ...
    $.ajax({
        ...
        method: "GET",
        url: "http://localhost:8090/EMSPro/auth/tpsoverview/totalSteamGenerated",
...
function getCardValue8() {
    ...
    $.ajax({
        ...
        method: "GET",
        url: "http://localhost:8090/EMSPro/auth/tpsoverview/overallEfficiency",
...
function getCardValue9() {
    ...
    $.ajax({
        ...
        method: "GET",
        url: "http://localhost:8090/EMSPro/auth/tpsoverview/grossHeatRate",
...
function getTotalGenerationCostData(intervalType) {
    ...
    $.ajax({
        ...
        url: "http://localhost:8090/EMSPro/auth/tpsoverview/fuelOilConsumptionGraph",
