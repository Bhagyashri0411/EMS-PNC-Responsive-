...
function getSpecificlinesteamTurData(tagname) {
    ...
    $.ajax({
        ...
        url: "http://localhost:8090/EMSPro/auth/Equipmentlevelopt/SteamTurbineExtractionGraph",
    }).done(function (data) {
        console.log(data)
...
function steamturbinetable() {
    $.ajax({
        method: 'GET',
        url: 'http://localhost:8090/EMSPro/auth/Equipmentlevelopt/SteamTurbineExtraction',
    }).done(function (data) {
