...
function getSpecificlinesteamLenData() {
    ...
    $.ajax({
        ...
        url: "http://localhost:8090/EMSPro/auth/Equipmentlevelopt/steamletdownGraph",
    }).done(function (data) {
        console.log(data)
...
function steamletdowntable() {
    $.ajax({
        method: 'GET',
        url: 'http://localhost:8090/EMSPro/auth/Equipmentlevelopt/Steamletdown',
    }).done(function (data) {
        ...
        getsteamletdowntable(failData)
    })
}
function getsteamletdowntable(data) {
 var max1= 500;
var table_data = '';
...
$('#letdowntable').append(table_data);
}