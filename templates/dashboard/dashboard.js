...
function getSpecificHomeConsumptionData(intervalType, domLebal1) {
  ...
  $.ajax({
    ...
    url: "http://localhost:8090/EMSPro/home/homepagegraph",
  }).done(function (data) {
    console.log(data);
...
function totalThroughput() {
  $.ajax({
    ...
    url: "http://localhost:8090/EMSPro/home/totalbalance",
    method: "GET",
  }).done(function (data) {
...
function Truncated() {
  $.ajax({
    ...
    method: "GET",
    url: "http://localhost:8090/EMSPro/home/Truncate",
  }).done(function (data) {
    console.log(data);
  });
}
function csvdownload() {
  $.ajax({
    ...
    method: "GET",
    url: "http://localhost:8090/EMSPro/home/Report",
  }).done(function (data) {
    console.log(data);
