...
X=F[P+"Month"](),a=F[P+"FullYear"](),d=F[P+"Hours"](),c=F[P+"Minutes"](),b=F[P+"Seconds"](),e=F[P+"Milliseconds"](),f=I?0:F.getTimezoneOffset();return P=N.replace(h,function(l){switch(l){case "D":return T;case "DD":return Y(T,2);case "DDD":return J[M];case "DDDD":return K[M];case "M":return X+1;case "MM":return Y(X+1,2);case "MMM":return U[X];case "MMMM":return R[X];case "Y":return parseInt(String(a).slice(-2));case "YY":return Y(String(a).slice(-2),2);case "YYY":return Y(String(a).slice(-3),3);case "YYYY":return Y(a,
4);case "h":return d%12||12;case "hh":return Y(d%12||12,2);case "H":return d;case "HH":return Y(d,2);case "m":return c;case "mm":return Y(c,2);case "s":return b;case "ss":return Y(b,2);case "f":return Y(String(e),3).slice(0,1);case "ff":return Y(String(e),3).slice(0,2);case "fff":return Y(String(e),3).slice(0,3);case "t":return 12>d?"a":"p";case "tt":return 12>d?"am":"pm";case "T":return 12>d?"A":"P";case "TT":return 12>d?"AM":"PM";case "K":return I?"UTC":(String(F).match(x)||[""]).pop().replace(E,
"");case "z":return(0<f?"-":"+")+Math.floor(Math.abs(f)/60);case "zz":return(0<f?"-":"+")+Y(Math.floor(Math.abs(f)/60),2);case "zzz":return(0<f?"-":"+")+Y(Math.floor(Math.abs(f)/60),2)+Y(Math.abs(f)%60,2);default:return l.slice(1,l.length-1)}})}}(),da=function(h,n,v){if(null===h)return"";if(!isFinite(h))return h;h=Number(h);var s=0>h?!0:!1;s&&(h*=-1);var w=v?v.decimalSeparator:".",x=v?v.digitGroupSeparator:",",E="";n=String(n);var E=1,F=v="",N=-1,P=[],K=[],R=0,J=0,U=0,I=!1,T=0,F=n.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
...
n=E.split(".");E=(n[0]+"").split("");h=(n[1]+"").split("");E&&"0"===E[0]&&E.shift();for(I=F=M=J=N=0;0<P.length;)if(n=P.pop(),"#"===n||"0"===n)if(N++,N===R){var X=E,E=[];if("0"===n)for(n=R-J-(X?X.length:0);0<n;)X.unshift("0"),n--;for(;0<X.length;)v=X.pop()+v,I++,0===I%F&&(M===U&&0<X.length)&&(v=x+v)}else 0<E.length?(v=E.pop()+v,J++,I++):"0"===n&&(v="0"+v,J++,I++),0===I%F&&(M===U&&0<E.length)&&(v=x+v);else"E"!==n[0]&&"e"!==n[0]||"0"!==n[n.length-1]||!/[eE][+-]*[0]+/.test(n)?","===n?(M++,F=I,I=0,0<E.length&&
(v=x+v)):v=1<n.length&&('"'===n[0]&&'"'===n[n.length-1]||"'"===n[0]&&"'"===n[n.length-1])?n.slice(1,n.length-1)+v:n+v:(n=0>T?n.replace("+","").replace("-",""):n.replace("-",""),v+=n.replace(/[0]+/,function(a){return Y(T,a.length)}));x="";for(P=!1;0<K.length;)n=K.shift(),"#"===n||"0"===n?0<h.length&&0!==Number(h.join(""))?(x+=h.shift(),P=!0):"0"===n&&(x+="0",P=!0):1<n.length&&('"'===n[0]&&'"'===n[n.length-1]||"'"===n[0]&&"'"===n[n.length-1])?x+=n.slice(1,n.length-1):"E"!==n[0]&&"e"!==n[0]||"0"!==n[n.length-
1]||!/[eE][+-]*[0]+/.test(n)?x+=n:(n=0>T?n.replace("+","").replace("-",""):n.replace("-",""),x+=n.replace(/[0]+/,function(a){return Y(T,a.length)}));v+=(P?w:"")+x;return s?"-"+v:v},Na=function(h){var n=0,v=0;h=h||window.event;h.offsetX||0===h.offsetX?(n=h.offsetX,v=h.offsetY):h.layerX||0==h.layerX?(n=h.layerX,v=h.layerY):(n=h.pageX-h.target.offsetLeft,v=h.pageY-h.target.offsetTop);return{x:n,y:v}},$a=!0,Ra=window.devicePixelRatio||1,Ma=1,ja=$a?Ra/Ma:1,ba=function(h,n,v,s,w,x,E,F,N,P,R,K,J){"undefined"===
...
this.startValue)+(this.endValue.getTime?this.endValue.getTime():this.endValue))/2,this._thicknessType=null)}function Z(a,d,c){Z.base.constructor.call(this,"Crosshair","crosshair",d,null,c);this.chart=a;this.ctx=this.chart.ctx;this.axis=c;this.optionsName="crosshair";this._thicknessType="pixel"}function Y(a,d){Y.base.constructor.call(this,"ToolTip","toolTip",d,null,a);this.chart=a;this.canvas=a.canvas;this.ctx=this.chart.ctx;this.currentDataPointIndex=this.currentSeriesIndex=-1;this._prevY=this._prevX=
NaN;this.containerTransitionDuration=0.1;this.mozContainerTransition=this.getContainerTransition(this.containerTransitionDuration);this.optionsName="toolTip";this._initialize()}function ca(a){this.chart=a;this.lastObjectId=0;this.objectMap=[];this.rectangularRegionEventSubscriptions=[];this.previousDataPointEventObject=null;this.ghostCanvas=ra(this.chart.width,this.chart.height);this.ghostCtx=this.ghostCanvas.getContext("2d");this.mouseoveredObjectMaps=[]}function W(a){this.chart=a;this.ctx=this.chart.plotArea.ctx;
...
new Ia(this.options.culture);this.updateOption("animationEnabled");this.animationEnabled=this.animationEnabled&&w;this.updateOption("animationDuration");this.updateOption("rangeChanging");this.updateOption("rangeChanged");this.updateOption("exportEnabled");this.updateOption("exportFileName");this.updateOption("zoomType");this.toolbar=new Ta(this,this.options.toolbar);if(this.options.zoomEnabled||this.panEnabled){if(this._zoomButton)ga(this._zoomButton,{borderRight:this.toolbar.buttonBorderThickness+
...
function(a){d=!0},this.allDOMEventHandlers);J(this._zoomButton,"click",function(){a.zoomEnabled?(a.zoomEnabled=!1,a.panEnabled=!0,ua(a,a._zoomButton,"zoom")):(a.zoomEnabled=!0,a.panEnabled=!1,ua(a,a._zoomButton,"pan"));a.render()},this.allDOMEventHandlers);J(this._zoomButton,"mousemove",function(){d?d=!1:(ga(a._zoomButton,{backgroundColor:a.toolbar.itemBackgroundColorOnHover,color:a.toolbar.fontColorOnHover,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&ga(a._zoomButton.childNodes[0],
...
null;a.resetOverlayedCanvas();0>=navigator.userAgent.search("MSIE")&&ga(a._resetButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"});ta(a._zoomButton,a._resetButton);a.stockChart&&(a.stockChart._rangeEventParameter={stockChart:a.stockChart,source:"chart",index:a.stockChart.charts.indexOf(a),minimum:null,maximum:null});a._dispatchRangeEvent("rangeChanging","reset");a.stockChart&&(a.stockChart._rangeEventParameter.type="rangeChanging",a.stockChart.dispatchEvent("rangeChanging",a.stockChart._rangeEventParameter,
a.stockChart));a.render();a.syncCharts&&a.syncCharts(null,null);a._dispatchRangeEvent("rangeChanged","reset");a.stockChart&&(a.stockChart._rangeEventParameter.type="rangeChanged",a.stockChart.dispatchEvent("rangeChanged",a.stockChart._rangeEventParameter,a.stockChart))},this.allDOMEventHandlers),J(this._resetButton,"mousemove",function(){d||(ga(a._resetButton,{backgroundColor:a.toolbar.itemBackgroundColorOnHover,color:a.toolbar.fontColorOnHover,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&
ga(a._resetButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},this.allDOMEventHandlers),J(this._resetButton,"mouseout",function(){d||(ga(a._resetButton,{backgroundColor:a.toolbar.itemBackgroundColor,color:a.toolbar.fontColor,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&ga(a._resetButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"}))},this.allDOMEventHandlers),this.overlaidCanvas.style.cursor=a._defaultCursor);this.zoomEnabled||
this.panEnabled||(this._zoomButton?(a._zoomButton.getAttribute("state")===a._cultureInfo.zoomText?(this.panEnabled=!0,this.zoomEnabled=!1):(this.zoomEnabled=!0,this.panEnabled=!1),Ka(a._zoomButton,a._resetButton)):(this.zoomEnabled=!0,this.panEnabled=!1))}else this.panEnabled=this.zoomEnabled=!1;gb(this);"none"!==this._toolBar.style.display&&this._zoomButton&&(this.panEnabled?ua(a,a._zoomButton,"zoom"):ua(a,a._zoomButton,"pan"),a._resetButton.getAttribute("state")!==a._cultureInfo.resetText&&ua(a,
...
this.layoutManager=new Ca(0,0,this.width,this.height,this.isNavigator?0:2);this.plotArea.layoutManager&&this.plotArea.layoutManager.reset();this.data=[];this.title=null;this.subtitles=[];var a=0,d=null;if(this.options.data){for(var c=0;c<this.options.data.length;c++)if(a++,!this.options.data[c].type||0<=n._supportedChartTypes.indexOf(this.options.data[c].type)){var b=new K(this,this.options.data[c],a-1,++this._eventManager.lastObjectId);"error"===b.type&&(b.linkedDataSeriesIndex=s(this.options.data[c].linkedDataSeriesIndex)?
...
d||"normal",this.data[c]._linkedSeries=null===this.data[c].linkedDataSeriesIndex?null:this.data[this.data[c].linkedDataSeriesIndex])}}this._objectsInitialized=!0;this._plotAreaElements=[]};n._supportedChartTypes=Ba("line stepLine spline column area stepArea splineArea bar bubble scatter stackedColumn stackedColumn100 stackedBar stackedBar100 stackedArea stackedArea100 candlestick ohlc boxAndWhisker rangeColumn error rangeBar rangeArea rangeSplineArea pie doughnut funnel pyramid waterfall".split(" "));
...
this.data[a.dataSeriesIndexes[m]],q=0,g=!1,r=!1,h;if("normal"===p.axisPlacement||"xySwapped"===p.axisPlacement)var Pa=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:-Infinity,u=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?
this.options.axisX.viewportMaximum:this.options.axisX&&this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(p.dataPoints[q].x&&p.dataPoints[q].x.getTime||"dateTime"===p.xValueType)f=!0;for(q=0;q<p.dataPoints.length;q++){"undefined"===typeof p.dataPoints[q].x&&(p.dataPoints[q].x=q+(a.axisX.logarithmic?1:0));p.dataPoints[q].x.getTime?(f=!0,b=p.dataPoints[q].x.getTime()):b=p.dataPoints[q].x;e=s(p.dataPoints[q].y)?0:p.dataPoints[q].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);if(0<q){if(a.axisX.logarithmic){var n=
b/p.dataPoints[q-1].x;1>n&&(n=1/n);c.minDiff>n&&1!==n&&(c.minDiff=n)}else n=b-p.dataPoints[q-1].x,0>n&&(n*=-1),c.minDiff>n&&0!==n&&(c.minDiff=n);null!==e&&null!==p.dataPoints[q-1].y&&(a.axisY.logarithmic?0<e&&(n=e/p.dataPoints[q-1].y,1>n&&(n=1/n),d.minDiff>n&&1!==n&&(d.minDiff=n)):(n=e-p.dataPoints[q-1].y,0>n&&(n*=-1),d.minDiff>n&&0!==n&&(d.minDiff=n)))}if(b<Pa&&!g)null!==p.dataPoints[q].y&&(h=b);else{if(!g&&(g=!0,0<q)){q-=2;continue}if(b>u&&!r)r=!0;else if(b>u&&r)continue;p.dataPoints[q].label&&
(a.axisX.labels[b]=p.dataPoints[q].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===p.dataPoints[q].y?c.viewPortMin===b&&h<b&&(c.viewPortMin=h):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?l[b]?l[b]+=e:(l[b]=e,B=Math.min(e,B)):t[b]?t[b]+=e:(t[b]=e,k=Math.max(e,k)))}}a.axisY.scaleBreaks&&(a.axisY.scaleBreaks.autoCalculate&&1<=a.axisY.scaleBreaks.maxNumberOfAutoBreaks)&&(d.dataPointYPositiveSums?
(d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums,l),d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums,t)):(d.dataPointYPositiveSums=l,d.dataPointYNegativeSums=t));p.axisX.valueType=p.xValueType=f?"dateTime":"number"}for(q in l)l.hasOwnProperty(q)&&!isNaN(q)&&(a=l[q],a<d.min&&(d.min=Math.min(a,B)),a>d.max&&(d.max=a),q<c.viewPortMin||q>c.viewPortMax||(a<d.viewPortMin&&(d.viewPortMin=Math.min(a,B)),a>d.viewPortMax&&(d.viewPortMax=a)));for(q in t)t.hasOwnProperty(q)&&!isNaN(q)&&
(a=t[q],a<d.min&&(d.min=a),a>d.max&&(d.max=Math.max(a,k)),q<c.viewPortMin||q>c.viewPortMax||(a<d.viewPortMin&&(d.viewPortMin=a),a>d.viewPortMax&&(d.viewPortMax=Math.max(a,k))))}};n.prototype._processStacked100PlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)){for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,l=!1,t=!1,B=[],k=0;k<a.dataSeriesIndexes.length;k++){var m=this.data[a.dataSeriesIndexes[k]],p=0,q=!1,g=!1,r;if("normal"===m.axisPlacement||"xySwapped"===m.axisPlacement)var h=
...
Infinity;if(m.dataPoints[p].x&&m.dataPoints[p].x.getTime||"dateTime"===m.xValueType)f=!0;for(p=0;p<m.dataPoints.length;p++){"undefined"===typeof m.dataPoints[p].x&&(m.dataPoints[p].x=p+(a.axisX.logarithmic?1:0));m.dataPoints[p].x.getTime?(f=!0,b=m.dataPoints[p].x.getTime()):b=m.dataPoints[p].x;e=s(m.dataPoints[p].y)?null:m.dataPoints[p].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);if(0<p){if(a.axisX.logarithmic){var u=b/m.dataPoints[p-1].x;1>u&&(u=1/u);c.minDiff>u&&1!==u&&(c.minDiff=u)}else u=b-m.dataPoints[p-
1].x,0>u&&(u*=-1),c.minDiff>u&&0!==u&&(c.minDiff=u);s(e)||null===m.dataPoints[p-1].y||(a.axisY.logarithmic?0<e&&(u=e/m.dataPoints[p-1].y,1>u&&(u=1/u),d.minDiff>u&&1!==u&&(d.minDiff=u)):(u=e-m.dataPoints[p-1].y,0>u&&(u*=-1),d.minDiff>u&&0!==u&&(d.minDiff=u)))}if(b<h&&!q)null!==e&&(r=b);else{if(!q&&(q=!0,0<p)){p-=2;continue}if(b>n&&!g)g=!0;else if(b>n&&g)continue;m.dataPoints[p].label&&(a.axisX.labels[b]=m.dataPoints[p].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===
e?c.viewPortMin===b&&r<b&&(c.viewPortMin=r):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?l=!0:0>e&&(t=!0),B[b]=B[b]?B[b]+Math.abs(e):Math.abs(e))}}m.axisX.valueType=m.xValueType=f?"dateTime":"number"}a.axisY.logarithmic?(d.max=s(d.viewPortMax)?99*Math.pow(a.axisY.logarithmBase,-0.05):Math.max(d.viewPortMax,99*Math.pow(a.axisY.logarithmBase,-0.05)),d.min=s(d.viewPortMin)?1:Math.min(d.viewPortMin,1)):l&&!t?(d.max=s(d.viewPortMax)?
...
k.dataPoints[m-1].y[0],1>r&&(r=1/r),d.minDiff>r&&1!==r&&(d.minDiff=r)):(r=e[0]-k.dataPoints[m-1].y[0],0>r&&(r*=-1),d.minDiff>r&&0!==r&&(d.minDiff=r))));if(!(b<n)||p){if(!p&&(p=!0,0<m)){m-=2;g=h;continue}if(b>u&&!q)q=!0;else if(b>u&&q)continue;k.dataPoints[m].label&&(a.axisX.labels[b]=k.dataPoints[m].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);if(c.viewPortMin===b&&e)for(y=0;y<e.length;y++)if(null===e[y]&&g<b){c.viewPortMin=g;break}null===e?c.viewPortMin===b&&g<b&&
...
(p=k.lineDashType,c.setLineDash(g))));if(0<m[u].markerSize||0<k.markerSize){var A=k.getMarkerProperties(u,y,s,c);f.push(A);D=R(D);w&&f.push({x:y,y:s,ctx:b,type:A.type,size:A.size,color:D,borderColor:D,borderThickness:A.borderThickness})}(m[u].indexLabel||k.indexLabel||m[u].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"line",dataPoint:m[u],dataSeries:k,point:{x:y,y:s},direction:0>m[u].y===a.axisY.reversed?1:-1,color:r})}c.stroke();w&&b.stroke()}}X.drawMarkers(f);w&&
...
m[u].y===a.axisY.reversed?1:-1,color:r})}c.stroke();w&&b.stroke()}}X.drawMarkers(f);w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),b.beginPath());
...
(0<r[h].markerSize||0<g.markerSize)&&(s=g.getMarkerProperties(h,n,u,f),B.push(s),$=R($),w&&B.push({x:n,y:u,ctx:l,type:s.type,size:s.size,color:$,borderColor:$,borderThickness:s.borderThickness}));(r[h].indexLabel||g.indexLabel||r[h].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"area",dataPoint:r[h],dataSeries:g,point:{x:n,y:u},direction:0>r[h].y===a.axisY.reversed?1:-1,color:A})}b();X.drawMarkers(B)}}w&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
...
dataPoint:ea,dataSeries:A,point:{x:g,y:r},direction:0>v[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,r);w&&s.moveTo(g,r)}delete A.dataPointIndexes}X.drawMarkers(l);w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
...
(ea.indexLabel||A.indexLabel||ea.indexLabelFormatter||A.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea100",dataPoint:ea,dataSeries:A,point:{x:g,y:r},direction:0>x[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,r);w&&z.moveTo(g,r)}delete A.dataPointIndexes}X.drawMarkers(t);w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&
...
var g=q[e].z,s=2*Math.max(Math.sqrt((t===h?n/2:r+(n-r)/(t-h)*(g-h))/Math.PI)<<0,1),g=p.getMarkerProperties(e,c);g.size=s;c.globalAlpha=p.fillOpacity;X.drawMarker(f,l,c,g.type,g.size,g.color,g.borderColor,g.borderThickness);c.globalAlpha=1;var u=p.dataPointIds[e];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:m,dataPointIndex:e,x1:f,y1:l,size:s};s=R(u);w&&X.drawMarker(f,l,this._eventManager.ghostCtx,g.type,g.size,s,s,g.borderThickness);(q[e].indexLabel||p.indexLabel||
...
color:z})}else S||q||d(),S=!0;d();X.drawMarkers(f)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(l.x1,l.y1,l.width,l.height),this._eventManager.ghostCtx.restore());
...
1].newLineDashArray=A,C=k.nullDataLineDashType):(d(D,y),s=[],x=[])),g=!0;d(D,y);X.drawMarkers(f)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(l.x1,l.y1,l.width,l.height),
...
{chart:n})}))};d();l();l();l();l();this.disableToolTip=!0;this._animator.animate(0,this.animatedRender?this.animationDuration:0,function(a){var b=n.plotArea.ctx;b.clearRect(q.x1,q.y1,q.width,q.height);b.fillStyle=n.backgroundColor;b.fillRect(q.x1,q.y1,q.width,q.height);for(var b=g[0].startAngle+2*Math.PI*a,c=0;c<m.length;c++){var d=0===c?g[c].startAngle:e,e=d+(g[c].endAngle-g[c].startAngle),f=!1;e>b&&(e=b,f=!0);var l=m[c].color?m[c].color:k._colorSet[c%k._colorSet.length];e>d&&fa(n.plotArea.ctx,g[c].center,
...
u.reversed?ma+C:qa+C)-(0>a?u.reversed?qa-C:ma-C:H[a].textBlock.y+H[a].height+ca)}function n(a,b,c){var d,e,g,l=[],h=C,p=[];-1!==b&&(0<=W.indexOf(b)?(e=W.indexOf(b),W.splice(e,1)):(W.push(b),W=W.sort(function(a,b){return a-b})));if(0===W.length)l=fa;else{e=C*(1!=W.length||0!=W[0]&&W[0]!=Q.length-1?2:1)/k();for(var t=0;t<Q.length;t++){if(1==W.length&&0==W[0]){if(0===t){l.push(fa[t]);d=h;continue}}else 0===t&&(d=-1*h);l.push(fa[t]+d);if(0<=W.indexOf(t)||t<Q.length&&0<=W.indexOf(t+1))d+=e}}g=function(){for(var a=
...
(G=parseInt(G),G=G*a/100):G=parseInt(G),aa>E?aa=E:0>=aa&&(aa=0),G>a?G=a-0.5:0>=G&&(G=0)):"pyramid"===u.type&&(G=aa=0,u.reversed=u.reversed?!1:!0);var D=O+a/2,U=O,Y=O+a,ma=u.reversed?P:K,L=D-G/2,X=D+G/2,va=u.reversed?K+aa:P-aa,qa=u.reversed?K:P;a=[];var D=[],Q=[],F=[],V=K,ba,Z=(va-ma)/(L-U),da=-Z,O="area"===(u.valueRepresents?u.valueRepresents:"height")?c():d();if(-1!==O){if(u.reversed)for(F.push(V),G=O.length-1;0<G;G--)V+=O[G],F.push(V);else for(G=0;G<O.length;G++)V+=O[G],F.push(V);if(u.reversed)for(G=
0;G<O.length;G++)F[G]<va?(a.push(L),D.push(X),ba=G):(a.push((F[G]-ma+Z*U)/Z),D.push((F[G]-ma+da*Y)/da));else for(G=0;G<O.length;G++)F[G]<va?(a.push((F[G]-ma+Z*U)/Z),D.push((F[G]-ma+da*Y)/da),ba=G):(a.push(L),D.push(X));for(G=0;G<O.length-1;G++)V=u.reversed?y[y.length-1-G].color?y[y.length-1-G].color:u._colorSet[(y.length-1-G)%u._colorSet.length]:y[G].color?y[G].color:u._colorSet[G%u._colorSet.length],G===ba?Q.push({x1:a[G],y1:F[G],x2:D[G],y2:F[G],x3:X,y3:va,x4:D[G+1],y4:F[G+1],x5:a[G+1],y5:F[G+1],
x6:L,y6:va,id:G,height:F[G+1]-F[G],color:V}):Q.push({x1:a[G],y1:F[G],x2:D[G],y2:F[G],x3:D[G+1],y3:F[G+1],x4:a[G+1],y4:F[G+1],id:G,height:F[G+1]-F[G],color:V});var ca=2,H=[],ga=!1,W=[],fa=[],O=!1;a=a=0;Ba(W);for(G=0;G<y.length;G++)y[G].exploded&&(O=!0,u.reversed?W.push(y.length-1-G):W.push(G));R.clearRect(z.x1,z.y1,z.width,z.height);R.fillStyle=x.backgroundColor;R.fillRect(z.x1,z.y1,z.width,z.height);if(I&&u.visible&&(b(),f(),e(),"inside"!==u.indexLabelPlacement)){l();for(G=0;G<y.length;G++)H[G].isDirty||
...
Math.max(L,10)?Math.max(L,10):f.y1):f.y1<Math.max(L,10)?Math.max(L,10):f.y1;n=Math.round(f.x2-V-W);k=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y1:f.y2-T>m.height-Math.max(L,10)?m.height-Math.max(L,10):f.y2-T):f.y2>m.height-Math.max(L,10)?m.height-Math.max(L,10):f.y2;if(c&&0<c.length)for(L=0;L<c.length;L++)c[L]&&c[L].labelAutoFit&&(n=0>c[L].labelAngle?Math.max(n,y):0===c[L].labelAngle?Math.max(n,y/2):n,l=0>c[L].labelAngle||0===c[L].labelAngle?n-V:l);if(b&&0<b.length)for(L=0;L<b.length;L++)b[L]&&
...
"top"===this.parent._position)this._updatedValue=this.parent.convertPixelToValue(n);if("left"===this.parent._position||"right"===this.parent._position)this._updatedValue=this.parent.convertPixelToValue(w);q.globalAlpha=g};na(Y,I);Y.prototype._initialize=function(){this.updateOption("updated");this.updateOption("hidden");if(this.enabled){this.container=document.createElement("div");this.container.setAttribute("class","canvasjs-chart-tooltip");this.container.style.position="absolute";this.container.style.height=
...
dataPoint:f[b].dataPoint,dataSeries:f[b].dataSeries,dataPointIndex:f[b].index,dataSeriesIndex:f[b].dataSeries._index});d={chart:this.chart,toolTip:this.options,content:c,entries:d};this._entries=f;this.dispatchEvent("updated",d,this)}}else this.hide(),this.enabled&&this.dispatchEvent("hidden",{chart:this.chart,toolTip:this},this)}};Y.prototype.highlightObjects=function(a){var d=this.chart.overlaidCanvasCtx;if(s(this.chart.clearedOverlayedCanvas)||"toolTip"===this.chart.clearedOverlayedCanvas)this.chart.resetOverlayedCanvas(),
...
c.size,c.color,c.borderColor,c.borderThickness)}}};return n}();x.version="v3.4.9 GA";window.CanvasJS&&(x&&!window.CanvasJS.Chart)&&(window.CanvasJS.Chart=x)})();
